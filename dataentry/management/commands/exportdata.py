...
# proposed command = python mange.py exportdata model_name
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # search through from the installed apps for the model
        model =None
       ...
       # generate the timestamp of current date and time
        ...
        with open(file_path,'w',newline='') as file:
            ...
            #we want to print fields names of the model that we are trying to export
